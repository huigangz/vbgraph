 ...
 * single dotted-key table block (`[mcp_servers.vbgraph]`) inside an
 ...
 *
 * Strategy: treat the file as text. Find the `[mcp_servers.vbgraph]`
 ...
 *     the full dotted key `[mcp_servers.vbgraph]`).
