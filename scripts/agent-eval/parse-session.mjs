...
const explore = subCounts['mcp__vbgraph__vbgraph_explore'] || mainCounts['mcp__vbgraph__vbgraph_explore'] || 0;
...
console.log(`\nVERDICT: vbgraph_explore used ${explore}x | Read ${reads} | Grep/Bash ${greps}`);
